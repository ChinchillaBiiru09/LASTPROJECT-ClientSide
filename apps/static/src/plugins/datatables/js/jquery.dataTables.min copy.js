...
(function (f) {
    ...
    function lb(a) {
        if (!q.__browser) {
            ...
            q.__browser = b;
            var c = f("<div/>")
                    .css({ position: "fixed", top: 0, left: -1 * f(z).scrollLeft(), height: 1, width: 1, overflow: "hidden" })
                    .append(
                        f("<div/>")
            ...
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (h = n.length; m < h; m++)
                    if ("number" === typeof n[m] && 0 <= n[m]) {
                        ...
                        d(n[m], l);
                    } else if ("number" === typeof n[m] && 0 > n[m]) d(k.length + n[m], l);
        ...
        var b = function (a, d, e) {
            ...
            for (var g, k, l = 0, n = e.length - 1; l < n; l++) {
                ...
                if (g) {
                    ...
                    c.splice(0, l + 1);
                    g = c.join(".");
                    if (f.isArray(d)) for (k = 0, n = d.length; k < n; k++) (c = {}), b(c, d[k], g), a[e[l]].push(c);
                    else a[e[l]] = d;
                    return;
                }
    ...
    function Ma(a, b, c, d) {
        ...
        var w = function (a, b) {
            ...
            u = function (a) {
                if (c === p || c === k)
                    (g = n[k]), (l = f.trim(a.innerHTML)), g && g._bAttrSrc ? (Q(g.mData._)(d, l), w(g.mData.sort, a), w(g.mData.type, a), w(g.mData.filter, a)) : m ? (g._setter || (g._setter = Q(g.mData)), g._setter(d, l)) : (d[k] = l);
                k++;
            };
        if (h)
            for (; h; ) {
        ...
        if (-1 !== f.inArray(!1, b)) K(a, !1);
            ...
            if (0 !== l.length)
                ...
                (c = h.sZeroRecords),
                    ...
                    (b[0] = f("<tr/>", { class: e ? d[0] : "" }).append(f("<td />", { valign: "top", colSpan: W(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
    ...
    function na(a) {
        ...
        if (a.scrollBarVis !== D && a.scrollBarVis !== p) (a.scrollBarVis = D), aa(a);
            ...
            h = r.outerWidth();
            "" === c
                ? ((za.width = "100%"), x && (r.find("tbody").height() > k.offsetHeight || "scroll" == m.css("overflow-y")) && (za.width = B(r.outerWidth() - b)), (h = r.outerWidth()))
            ...
            r.outerWidth() < h
                ? ((F = k.scrollHeight > k.offsetHeight || "scroll" == m.css("overflow-y") ? h + b : h),
    ...
    function Ja(a) {
        ...
        if (d || (!u && !h && !e && k == W(a) && k == n.length)) for (q = 0; q < k; q++) (l = ba(a, q)), null !== l && (c[l].sWidth = B(n.eq(q).width()));
        else {
            ...
            for (q = 0; q < l.length; q++)
                (r = c[l[q]]),
                    ...
                    r.sWidthOrig && h && f(n[q]).append(f("<div/>").css({ width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
    ...
    function Za(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti
            ? ((c = f.inArray(b, J(e, "0"))), -1 !== c ? ((b = g(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = h[b]), (e[c]._idx = b))) : (e.push([b, h[0], 0]), (e[e.length - 1]._idx = 0)))
            : e.length && e[0][0] == b
    ...
    function ka(a, b) {
        ...
        b <= c
            ...
            : (a >= b - 1 - d ? (a = Z(b - (c - 2), b)) : ((a = Z(a - d + 2, a + d - 1)), a.push("ellipsis"), a.push(b - 1)), a.splice(0, 0, "ellipsis"), a.splice(0, 0, 0));
        a.DT_el = "span";
        return a;
    }
    function Ha(a) {
                        ...
                        f(z[0])
                            ...
                            .each(function (a, b) {
                                ...
                                if (c.mData === a) {
                                    ...
                                    if (null !== d || null !== b) (c.mData = { _: a + ".display", sort: null !== d ? a + ".@data-" + d : p, type: null !== d ? a + ".@data-" + d : p, filter: null !== b ? a + ".@data-" + b : p }), ma(r, a);
                                }
                            });
                    }
                    var C = r.oFeatures;
    ...
    v.register = t = function (a, b) {
        if (f.isArray(a)) for (var c = 0, d = a.length; c < d; c++) v.register(a[c], b);
        else {
            d = a.split(".");
            var e = Wb,
                h;
    ...
    t("page.info()", function (a) {
        ...
        var b = a._iDisplayStart,
            ...
            e = -1 === c;
        return { page: e ? 0 : Math.floor(b / c), pages: e ? 1 : Math.ceil(d / c), start: b, end: a.fnDisplayEnd(), length: c, recordsTotal: a.fnRecordsTotal(), recordsDisplay: d, serverSide: "ssp" === D(a) };
    });
        ...
        return eb(
            ...
            function (b) {
                ...
                if (null === b || b === p || c) {
                    n = [];
                    m = 0;
                    for (q = e.length; m < q; m++) for (k = e[m], u = 0; u < l; u++) (t = { row: k, column: u }), c ? ((v = d[k]), b(t, I(a, k, u), v.anCells ? v.anCells[u] : null) && n.push(t)) : n.push(t);
                    return n;
                }
                    ...
                    t = function (b, d) {
                        ...
                        for (p = d.length; w < p; w++) {
                            ...
                            if (f.isArray(v)) {
                                ...
                                null !== n &&
                                    ((x = f("<a>", { class: g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": l[v], "data-dt-idx": q, tabindex: x, id: 0 === c && "string" === typeof v ? a.sTableId + "_" + v : null })
                                        .html(n)
                                        .appendTo(b)),
                                    $a(x, { action: v }, u),
                                    q++);
